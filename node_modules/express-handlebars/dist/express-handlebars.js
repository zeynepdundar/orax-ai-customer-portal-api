...
class ExpressHandlebars {
    constructor(config = {}) {
        ...
        this.handlebars = (_a = config.handlebars) !== null && _a !== void 0 ? _a : Handlebars;
        this.extname = (_b = config.extname) !== null && _b !== void 0 ? _b : ".handlebars";
        this.encoding = (_c = config.encoding) !== null && _c !== void 0 ? _c : "utf8";
    ...
    _resolveViewsPath(views, file) {
        if (!Array.isArray(views)) {
            return views !== null && views !== void 0 ? views : null;
        }
